...
STATUS Add(                 Person** head,  char*           fname,      char*   sname, 
                                            char*           pname,      char*   job, 
                                            char*           vacancy,    char*   nomb, 
                                            char*           email,      char*   mess);

STATUS Edit(                Person* head,   unsigned int    id,         char*   fname, 
                                            char*           sname,      char*   pname, 
                                            char*           job,        char*   vacancy, 
                                            char*           nomb,       char*   email, 
                                            char*           mess);
...
void StatusToString(        STATUS status,  char            new_status[20]);

void PersonToString(        Person*         head,   
